...
don = pd.read_csv("C:/Users/cepe-s4-03/Documents/GB/data/SAh.csv", header=0, sep=",")
...
for app_index, val_index in skf.split(X,Y):
    ...
    ### forêt 500
    foret=RandomForestClassifier(n_estimators=500, max_features='sqrt').fit(Xapp,Yapp)
